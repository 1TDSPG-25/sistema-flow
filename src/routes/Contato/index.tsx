  ...
  return (
    ...
    "
      ...
      <div className="px-80 -mt-20 relative z-30">
        <div className=" flex h-fit shadow-lg shadow-gray-400 rounded-2xl">
            ...
            <form className="bg-[#FFFFFF] rounded-r-2xl w-1/2 flex flex-col justify-center px-10">
                ...
                <label htmlFor="nome" className="text-black text-2xl font-semibold mb-1">Nome:</label>
                ...
                <label htmlFor="email" className="text-black text-2xl font-semibold mb-1">E-mail:</label>
                ...
                <label htmlFor="mensagem" className="text-black text-2xl font-semibold mb-1">Escreva sua mensagem:</label>
