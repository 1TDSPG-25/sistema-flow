...
export default function Integrantes() {
  ...
  const IntegrantesData: IntegrantesDataType  = {
    equipeA: {
      ...
      hoverCard: "hover:bg-[rgba(31,114,238,0.2)]",
    ...
    equipeB: {
      ...
      hoverCard: "hover:bg-[rgba(28,193,102,0.2)]",
    ...
    equipeC: {
      ...
      hoverCard: "hover:bg-[rgba(193,72,28,0.2)]",
    ...
    equipeD: {
      ...
      hoverCard: "hover:bg-[rgba(255,247,0,0.2)]", 
    ...
    equipeE: {
      ...
      hoverCard: "hover:bg-[rgba(255,174,0,0.2)]",
    ...
    equipeF: {
      ...
      hoverCard: "hover:bg-[rgba(255,0,238,0.2)]",
    ...
    equipeG: {
      ...
      hoverCard: "hover:bg-[rgba(69,1,255,0.2)]",
    ...
    equipeH: {
      ...
      hoverCard: "hover:bg-[rgba(209,28,28,0.2)]",
