    ...
    return (
      <>
        ...
        >
          ...
          >
            ...
            <li className="bg-[#EFD2C3] border-[#EA7D44] rounded-[30px] border-[3px] p-6">
              ...
              <p
                className="font-bold text-3xl mt-5 mb-3
              md:mt-10 lg:mt-13"
              >
                Redes Sociais:
              </p>
        ...
        <section className="pl-8 flex flex-col justify-center items-center gap-10 pt-20">
          ...
          {/* Card tarefa 1 */}
          <div
            className="bg-[#EFD2C3] border-[#EA7D44] rounded-[30px] border-[3px] p-6 mt-2 flex flex-col justify-center items-center text-center w-[90%]
          lg:p-8
          2xl:p-13"
          >
            <div
            ...
            >
              ...
              <div>
                ...
                <Link
                  ...
                  hover:bg-[rgb(207,77,7)] transition duration-300
                  sm:text-xl
                  md:text-2xl
                  lg:w-[30%]
                  2xl:p-3"
          ...
          {/* Card tarefa 2 */}
          <div
            className="bg-[#EFD2C3] border-[#EA7D44] rounded-[30px] border-[3px] p-6 mt-10 flex flex-col items-center text-center w-[90%]
          2xl:p-13"
          >
            <div
              className="flex flex-col justify-center items-center
