                ...
                <form onSubmit={onSubmit} className="frmLogin">
                    <fieldset>
                        ...
                        <div>
                            ...
                            <input type="text" id="idEmail" className="bg-amber-200" 
                            {...register("email", { required: "Insira email do usuário", 
    })} 
                            aria-invalid={!!errors.email} 
                            aria-describedby={errors.email ? "email-error" : undefined} />
                             
                             {errors.email && <span role="alert" id="email-error" 
                             className="text-red-600 bg-red-300 border-[1px] border-red-600 rounded-md p-2">{errors.email.message}</span>}
                        </div>
                        <div>
